...
<head>
    <meta charset="UTF-8">
    <title>Crear Tarjeta | Banco Santandor</title>
    <!--Favicon-->
...
<center>
    <form method="post" action="../resources/php/add-card.php" id="createcc" name="createcc" style="width: 59%; text-align: center">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 form-group">
                <p>Seleccione tipo de tarjeta:</p>
                <input type="radio" name="type" id="debit" value="debit" required>
                <label for="save">Debito</label>
                &nbsp;&nbsp;
                <input type="radio" name="type" id="credit" value="credit" required>
                <label for="out">Credito</label>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 form-group">
                <input type="text" class="form-control" name="cardname" id="cardname" placeholder="Nombre para la Tarjeta" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
